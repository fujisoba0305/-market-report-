...
SECTOR_COMPANIES = {
    ...
    "建設": ["大成建設", "鹿島", "大林組", "清水建設"],
    "保険": ["東京海上", "SOMPOホールディングス", "第一生命"],
    "化学": ["三菱ケミカル", "住友化学", "信越化学"],
    "食品": ["味の素", "日清食品", "キリンホールディングス", "アサヒグループ"],
    "鉄鋼・金属": ["日本製鉄", "JFEホールディングス", "神戸製鋼所"],
}
...
US_RATE_SENSITIVITY = {
    "上昇": {"銀行": 1, "保険": 1, "半導体": -1, "不動産": -1},
    "低下": {"銀行": -1, "保険": -1, "半導体": 1, "不動産": 1},
}
